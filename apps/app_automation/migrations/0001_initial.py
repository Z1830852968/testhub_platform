    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="组件类型"
                    ),
                ),
                (
                    "category",
                ...
                (
                    "default_config",
                    models.JSONField(default=dict, verbose_name="默认配置"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "version",
                    models.CharField(
                        blank=True, default="", max_length=50, verbose_name="版本"
                    ),
                ),
                (
                    "description",
                ...
                (
                    "author",
                    models.CharField(
                        blank=True, default="", max_length=100, verbose_name="作者"
                    ),
                ),
                (
                    "source",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "device_id",
                    models.CharField(
                        max_length=255, unique=True, verbose_name="设备序列号"
                    ),
                ),
                (
                    "name",
                ...
                (
                    "ip_address",
                    models.CharField(
                        blank=True, default="", max_length=50, verbose_name="IP地址"
                    ),
                ),
                ...
                (
                    ...
                    models.JSONField(
                        default=dict,
                        help_text="RAM, CPU, 分辨率等信息",
                        verbose_name="设备规格",
                    ),
                ),
                (
                    "description",
                    models.TextField(blank=True, default="", verbose_name="设备描述"),
                ),
                (
                    "location",
                    models.CharField(
                        blank=True, default="", max_length=200, verbose_name="设备位置"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_active",
                    models.BooleanField(
                        default=True, help_text="软删除标记", verbose_name="是否启用"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "recipient_info",
                    models.JSONField(default=list, verbose_name="收件人信息"),
                ),
                (
                    "webhook_bot_info",
                    models.JSONField(
                        blank=True, default=dict, verbose_name="Webhook机器人信息"
                    ),
                ),
                ...
                (
                    "response_info",
                    models.JSONField(blank=True, default=dict, verbose_name="响应信息"),
                ),
                (
                    "created_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="创建时间"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "variables",
                    models.JSONField(
                        default=list, help_text="测试变量列表", verbose_name="变量定义"
                    ),
                ),
                (
                    "timeout",
                    models.IntegerField(
                        default=300, help_text="默认5分钟", verbose_name="超时时间(秒)"
                    ),
                ),
                (
                    "retry_count",
                    models.IntegerField(default=0, verbose_name="失败重试次数"),
                ),
                (
                    "created_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="创建时间"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "progress",
                    models.IntegerField(default=0, verbose_name="执行进度(0-100)"),
                ),
                (
                    "started_at",
                    models.DateTimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(blank=True, default="", verbose_name="套件描述"),
                ),
                (
                    "execution_status",
                    models.CharField(
