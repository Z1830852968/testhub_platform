    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "api_key",
                    models.CharField(
                        blank=True, max_length=200, null=True, verbose_name="API Key"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "requirement_id",
                    models.CharField(max_length=50, verbose_name="需求编号"),
                ),
                (
                    "requirement_name",
                    models.CharField(max_length=200, verbose_name="需求名称"),
                ),
                (
                    "requirement_type",
                    models.CharField(
                ...
                (
                    "reviewer",
                    models.CharField(
                        default="admin", max_length=50, verbose_name="评审人"
                    ),
                ),
                (
                    "estimated_hours",
                    models.PositiveIntegerField(default=8, verbose_name="预计工时"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "generated_by_ai",
                    models.CharField(
                        default="AI-A", max_length=50, verbose_name="生成AI模型"
                    ),
                ),
                (
                    "reviewed_by_ai",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="评审AI模型"
                    ),
                ),
                (
                    "review_comments",
                    models.TextField(blank=True, verbose_name="评审意见"),
                ),
                (
                    "created_at",
                    models.DateTimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "analysis_report",
                    models.TextField(blank=True, verbose_name="分析报告"),
                ),
                (
                    "requirements_count",
                    models.PositiveIntegerField(default=0, verbose_name="需求数量"),
                ),
                (
                    "analysis_time",
                    models.FloatField(
                        blank=True, null=True, verbose_name="分析耗时(秒)"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(
                        upload_to="requirement_docs/%Y/%m/", verbose_name="文档文件"
                    ),
                ),
                (
                    "document_type",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="文件大小(bytes)"
                    ),
                ),
                (
                    "extracted_text",
                    models.TextField(blank=True, verbose_name="提取的文本内容"),
                ),
            ],
            options={
                "verbose_name": "需求文档",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "stream_buffer",
                    models.TextField(blank=True, verbose_name="流式输出缓冲区"),
                ),
                (
                    "stream_position",
                ...
                (
                    "last_stream_update",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="最后流式更新时间"
                    ),
                ),
                (
                    "generated_test_cases",
                    models.TextField(blank=True, verbose_name="生成的测试用例"),
                ),
                (
                    "review_feedback",
                    models.TextField(blank=True, verbose_name="评审反馈"),
                ),
                (
                    "final_test_cases",
                    models.TextField(blank=True, verbose_name="最终测试用例"),
                ),
                (
                    "generation_log",
                    models.TextField(blank=True, verbose_name="生成日志"),
                ),
                (
                    "error_message",
                    models.TextField(blank=True, verbose_name="错误信息"),
                ...
                (
                    "is_saved_to_records",
                    models.BooleanField(default=False, verbose_name="是否已保存到记录"),
                ),
                (
                    "saved_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="保存到记录时间"
                    ),
                ),
            ],
            options={
