    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "task_description",
                    models.TextField(
                        help_text="自然语言任务描述", verbose_name="任务描述"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "case_name",
                    models.CharField(max_length=200, verbose_name="用例名称快照"),
                ),
                (
                    "task_description",
                    models.TextField(
                ...
                (
                    "logs",
                    models.TextField(blank=True, default="", verbose_name="执行日志"),
                ),
                (
                    "steps_completed",
                    models.JSONField(default=list, verbose_name="已完成步骤"),
                ),
                (
                    "planned_tasks",
                    models.JSONField(default=list, verbose_name="规划任务"),
                ),
                (
                    "gif_path",
                    models.CharField(
                        ...
                        max_length=500,
                        null=True,
                        verbose_name="GIF录制路径",
                    ),
                ),
                (
                    "screenshots_sequence",
                    models.JSONField(default=list, verbose_name="截图序列"),
                ),
            ],
            options={
                "verbose_name": "AI测试报告",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "locator_value",
                    models.CharField(max_length=500, verbose_name="定位表达式"),
                ),
                (
                    "backup_locators",
                    models.JSONField(
                ...
                (
                    "page",
                    models.CharField(
                        blank=True, max_length=200, verbose_name="所属页面"
                    ),
                ),
                (
                    "component_name",
                ...
                (
                    "is_unique",
                    models.BooleanField(default=False, verbose_name="是否唯一"),
                ),
                (
                    "wait_timeout",
                    models.IntegerField(default=5, verbose_name="等待超时(秒)"),
                ),
                (
                    "is_visible",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="对visibility:hidden的元素使用force选项",
                        verbose_name="强制操作",
                    ),
                ),
                (
                ...
                (
                    "validation_message",
                    models.TextField(blank=True, verbose_name="验证消息"),
                ),
                (
                    "created_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="创建时间"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        upload_to="ui_screenshots/", verbose_name="截图文件"
                    ),
                ),
                ("description", models.TextField(blank=True, verbose_name="截图描述")),
                (
                    "captured_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="捕获时间"),
                ),
            ],
            options={
                "verbose_name": "UI截图",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "line_number",
                    models.IntegerField(
                        help_text="在脚本中的行号", verbose_name="行号"
                    ),
                ),
                (
                    "context",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(max_length=500, verbose_name="步骤描述"),
                ),
                (
                    "expected_result",
                    models.CharField(
                        blank=True, max_length=500, verbose_name="预期结果"
                    ),
                ),
                (
                    "wait_before",
                    models.IntegerField(default=0, verbose_name="执行前等待(毫秒)"),
                ),
                (
                    "wait_after",
                    models.IntegerField(default=0, verbose_name="执行后等待(毫秒)"),
                ),
                (
                    "retry_count",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "browser",
                    models.CharField(
                        default="chrome", max_length=50, verbose_name="浏览器"
                    ),
                ),
                (
                    "headless",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "wait_time",
                    models.IntegerField(default=1000, verbose_name="等待时间(毫秒)"),
                ),
                (
                    "assert_type",
                    models.CharField(
                ...
                (
                    "assert_value",
                    models.TextField(blank=True, verbose_name="断言期望值"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "browser_type",
                    models.CharField(max_length=50, verbose_name="浏览器类型"),
                ),
                (
                    "browser_version",
                    models.CharField(
                ...
                (
                    "os_type",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="操作系统"
                    ),
                ),
                (
                    "os_version",
                ...
                (
                    "capabilities",
                    models.JSONField(
                        blank=True, null=True, verbose_name="浏览器能力配置"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "engine",
                    models.CharField(
                        default="playwright", max_length=20, verbose_name="测试引擎"
                    ),
                ),
                (
                    "browser",
                    models.CharField(
                        default="chrome", max_length=20, verbose_name="浏览器"
                    ),
                ),
                (
                    "headless",
                ...
                (
                    "result_data",
                    models.JSONField(
                        blank=True, null=True, verbose_name="执行结果数据"
                    ),
                ),
                (
                    "error_message",
                ...
                (
                    "report_url",
                    models.CharField(
                        blank=True, max_length=500, verbose_name="报告URL"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sender_name",
                    models.CharField(max_length=100, verbose_name="发件人姓名"),
                ),
                (
                    "sender_email",
                    models.EmailField(max_length=254, verbose_name="发件人邮箱"),
                ),
                (
                    "recipient_info",
                    models.JSONField(
                        help_text="接收通知的用户信息", verbose_name="收件人信息"
                    ),
                ),
                (
                    "webhook_bot_info",
                    models.JSONField(
                        ...
                        default=dict,
                        null=True,
                        verbose_name="Webhook机器人信息",
                    ),
                ),
                (
                    "notification_content",
                    models.TextField(
                        help_text="发送的通知内容", verbose_name="通知内容"
                    ),
                ),
                (
                    "status",
                ...
                (
                    "retry_count",
                    models.IntegerField(
                        default=0, help_text="已重试的次数", verbose_name="重试次数"
                    ),
                ),
                (
                    "is_retried",
                    models.BooleanField(default=False, verbose_name="是否已重试"),
                ),
            ],
            options={
                "verbose_name": "UI通知日志",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "browser",
                    models.CharField(
                        default="chrome", max_length=20, verbose_name="浏览器类型"
                    ),
                ),
                (
                    "headless",
                ...
                (
                    "notify_on_failure",
                    models.BooleanField(default=False, verbose_name="失败时通知"),
                ),
                (
                    "notification_type",
                    models.CharField(
                ...
                (
                    "notify_emails",
                    models.JSONField(
                        blank=True, default=list, verbose_name="通知邮箱列表"
                    ),
                ),
                (
                    "status",
                ...
                (
                    "last_run_time",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="最后运行时间"
                    ),
                ),
                (
                    "next_run_time",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="下次运行时间"
                    ),
                ),
                (
                    "total_runs",
                    models.IntegerField(default=0, verbose_name="总运行次数"),
                ),
                (
                    "successful_runs",
                    models.IntegerField(default=0, verbose_name="成功运行次数"),
                ),
                (
                    "failed_runs",
                    models.IntegerField(default=0, verbose_name="失败运行次数"),
                ),
                (
                    "last_result",
                    models.JSONField(default=dict, verbose_name="最后执行结果"),
                ),
                (
                    "error_message",
                    models.TextField(blank=True, verbose_name="错误信息"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_enabled",
                    models.BooleanField(default=False, verbose_name="是否启用通知"),
                ),
                (
                    "notify_on_success",
                    models.BooleanField(default=True, verbose_name="成功时通知"),
                ),
                (
                    "notify_on_failure",
                ...
                (
                    "notify_on_timeout",
                    models.BooleanField(default=False, verbose_name="超时时通知"),
                ),
                (
                    "notify_on_error",
                    models.BooleanField(default=True, verbose_name="错误时通知"),
                ),
                (
                    "custom_webhook_bots",
                    models.JSONField(
