        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "message_type",
                    models.CharField(
                        choices=[("user", "用户消息"), ("assistant", "助手回复")],
                        max_length=20,
                        verbose_name="消息类型",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "conversation_id",
                    models.CharField(
                        blank=True, max_length=200, null=True, verbose_name="Dify对话ID"
                    ),
                ),
                (
                    "title",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "api_url",
                    models.URLField(
                        help_text="Dify API endpoint URL",
                        max_length=500,
                ...
                (
                    "api_key",
                    models.CharField(
                        help_text="Dify API密钥", max_length=500, verbose_name="API Key"
                    ),
                ),
                (
                    "is_active",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "message_id",
                    models.CharField(
                        blank=True, max_length=200, null=True, verbose_name="Dify消息ID"
                    ),
                ),
                (
                    "created_at",
