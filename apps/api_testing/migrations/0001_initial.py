    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "base_url",
                    models.CharField(max_length=500, verbose_name="API Base URL"),
                ),
                (
                    "model_name",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "project_type",
                    models.CharField(
                        choices=[("HTTP", "HTTP"), ("WEBSOCKET", "WebSocket")],
                        max_length=20,
                        verbose_name="项目类型",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "pre_request_script",
                    models.TextField(blank=True, verbose_name="请求前脚本"),
                ),
                (
                    "post_request_script",
                    models.TextField(blank=True, verbose_name="请求后脚本"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "scope",
                    models.CharField(
                        choices=[("GLOBAL", "全局环境变量"), ("LOCAL", "局部环境变量")],
                        max_length=10,
                        verbose_name="作用域",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "notify_emails",
                    models.JSONField(default=list, verbose_name="通知邮箱列表"),
                ),
                (
                    "created_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="创建时间"),
